package com.cwjl.cn.view.headerrecycleview;
...
public class DeleteItemRecyclerView extends RecyclerView {

    //内置的HeaderViewAdapter包装对象。
    private HeaderViewAdapter mAdapter;
    private static final String TAG = "DeleteItemRecyclerView";
    ...
    public DeleteItemRecyclerView(Context context) {
        super(context);
        wrapHeaderAdapter();
    }

    public DeleteItemRecyclerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        mScroller = new Scroller(context);
        wrapHeaderAdapter();
    }

    public DeleteItemRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
