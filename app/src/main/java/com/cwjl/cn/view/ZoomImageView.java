...

{
    ...
    private float lastrectLeft;
    private float lastrectRight;
...
//			}
			...
			if ((rectF.left>=0&&dx>0&&lastrectLeft<=0)||(rectF.right<=getWidth()&&dx<0&&lastrectRight>=getWidth()))
			{
			...
			mLastX = x;
			mLastY = y;
			lastrectLeft=rectF.left;
			lastrectRight=rectF.right;
			break;
