...
//        fontImgPadding = px2designHeightPx(fontImgPadding);
     ...
     * @return TextView
     */
    public BottomTabBar setSpot(int index, int num, boolean isShow) {
        if (index > spots.size()) {
            ...
            if (isShow) {
                if (num >= 10) {
                    if (num >= 100)
                        spots.get(index).setText(99 + "+");
                    else
                        spots.get(index).setText(num + "");
                    spots.get(index).setPadding(dp2px(getResources(), 3), dp2px(getResources(), 1.9f), dp2px(getResources(), 3.3f), dp2px(getResources(), 2));
                } else {
                    spots.get(index).setText(num + "");
                    spots.get(index).setPadding(dp2px(getResources(), 7), dp2px(getResources(), 1.9f), dp2px(getResources(), 7), dp2px(getResources(), 2));
                }
    ...
    private View getTabItemView(String name, Drawable drawableSelect, Drawable drawableUnSelect) {
        ...
        if (realHeight == -1 && realWidth == -1) {
            ...
            tv.setTextSize(TypedValue.COMPLEX_UNIT_PX, (int) dp2px(getResources(), 12));
        }
    ...
    int dp2px(Resources resources, float dp) {
